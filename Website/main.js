...
const translations = {
  tr: {
    ...
    dl_title_1: "İndirme",
    dl_title_2: "Merkezi",
    dl_subtitle: "En güncel ve güvenli sürümü aşağıdaki kaynaklardan indirin.",
    dl_recommended: "Önerilen",
    dl_direct_title: "Direkt İndir — GitHub",
    dl_direct_desc: "Resmi GitHub Releases üzerinden hızlı ve güvenli indirme.",
    dl_btn_download: "Şimdi İndir",
    dl_drive_title: "Google Drive",
    dl_drive_desc: "Alternatif indirme kaynağı. Henüz hazır değil.",
    dl_btn_soon: "Çok Yakında",
    dl_unavailable: "Şu an kullanılamıyor",
    ver_title_1: "Tüm",
  ...
  en: {
    ...
    dl_title_1: "Download",
    dl_title_2: "Center",
    dl_subtitle: "Download the most current and secure version from the sources below.",
    dl_recommended: "Recommended",
    dl_direct_title: "Direct Download — GitHub",
    dl_direct_desc: "Fast and secure download via official GitHub Releases.",
    dl_btn_download: "Download Now",
    dl_drive_title: "Google Drive",
    dl_drive_desc: "Alternative download source. Not available yet.",
    dl_btn_soon: "Coming Soon",
    dl_unavailable: "Currently unavailable",
    ver_title_1: "All",
